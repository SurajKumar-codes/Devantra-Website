    ...
    <Section className="pt-32 pb-20">
      <Container>
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-6 text-gradient">Collaborations</h1>
          <p className="text-xl text-[var(--color-dark)] opacity-80 max-w-2xl mx-auto">
            Partner with us to build amazing products and grow together.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card hover className="p-8 text-center">
            ...
            <p className="text-[var(--color-dark)] opacity-70">Join our network of developers and organizations</p>
          </Card>
          ...
          <Card hover className="p-8 text-center">
            ...
            <p className="text-[var(--color-dark)] opacity-70">Enterprise solutions and team training programs</p>
          </Card>
          ...
          <Card hover className="p-8 text-center">
            ...
            <h3 className="text-xl font-bold mb-2">Educational Partners</h3>
            <p className="text-[var(--color-dark)] opacity-70">Universities and coding bootcamps</p>
          </Card>
        </div>
      </Container>
    </Section>
